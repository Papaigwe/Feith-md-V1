...
global.github = 'https://github.com/papaigwe/Feith-md V1'
global.location = 'pakistan'
global.gurl = 'https://instagram.com/darklove_' // add your username
global.sudo = process.env.SUDO || '24160338758'
global.devs = '923096566451';
global.website = 'https://github.com/papaigwe/Feith-md V1' // Hello world
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/a6b9bbde7feaa92c69c7b.jpg'
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Feith-md' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'papa igwe' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? '🦄' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'by feith-Md' : process.env.PACK_NAME.split(";")[1],
